---
name: fabric-exec
description: Use when checked TypeScript must compose bounded Power providers, perform non-trivial bounded data transformation, or access artifacts, memory, workspace state, or configured MCP federation. Do not use it to reimplement ordinary file, edit, shell, web, or subagent work owned by Kiro native tools.
license: MIT
compatibility: Kiro CLI v3 with the Kiro Fabric Power enabled
---
