 ...
 *
 *   KIRO_FABRIC_AGENT_DIR env  >  agents.sessionExportDir  >  ~/.pi/agent
 *
 * Prefer an isolated store instead? Set agents.sessionExportDir to
 * ~/.kiro-fabric/agent and register it as a ccusage pi.stores named store.
 */

export const SESSION_EXPORT_ENV = "KIRO_FABRIC_AGENT_DIR";
