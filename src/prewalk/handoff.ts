...
export const PREWALK_ARMED_MESSAGE_TYPE = "kiro-fabric-prewalk-armed";
const PREWALK_FAILURE_MESSAGE_TYPE = "kiro-fabric-prewalk-failure";
const PREWALK_CONTINUE_MESSAGE_TYPE = "kiro-fabric-prewalk-continue";
