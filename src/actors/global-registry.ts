...
import { isFabricActorRunner, type FabricAgentTransport } from "../config.js";
...
export class GlobalActorRegistry {
  ...
  #save(): void {
    const file: RegistryFile = { format: 2, actors: [...this.#actors.values()] };
