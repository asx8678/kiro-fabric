...
// from kiro-fabric's own module graph and hands createHighlighter the *object*,
...
describe("shiki host-loader theme resolution (#46)", () => {
  ...
  it("resolves a bundled theme id to its object from kiro-fabric's module graph", async () => {
