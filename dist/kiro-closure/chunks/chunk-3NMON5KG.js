...
var PI_CORE_COMPATIBILITY_ARGUMENT_TYPE_NAMES = {
...
var KIRO_ONLY_GUEST_TYPE_DECLARATIONS = `
...
var PI_LOOSE_DECLARATION = "declare const pi: PiToolsApi;\n";
...
var guestTypeDeclarations = (fullCodeMode, options = {}) => {
  ...
  if (options.coreToolNamespace === "k") {
    ...
    result = result.replace(
      ...
      (declaration) => declaration.replace("declare const pi:", "declare const k:").replace("PiToolsApi", "KiroToolsApi")
    );
    result = result.replace(
