...
var startKiroMcpServer = async () => {
  const { createKiroMcpServer } = await import("../chunks/mcp-server-WGQSSV4J.js");
  const { resolveKiroMcpLaunchEnvironment } = await import("../chunks/mcp-environment-JAJINY77.js");
