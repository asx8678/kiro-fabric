...
var startKiroMcpServer = async () => {
  const { createKiroMcpServer } = await import("../chunks/mcp-server-2AZEHNWM.js");
  const { resolveKiroMcpLaunchEnvironment } = await import("../chunks/mcp-environment-DURIRVPF.js");
