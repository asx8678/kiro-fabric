...
var startKiroMcpServer = async () => {
  const { createKiroMcpServer } = await import("../chunks/mcp-server-GMTV2JTN.js");
  const { resolveKiroMcpLaunchEnvironment } = await import("../chunks/mcp-environment-CRHIEVA5.js");
