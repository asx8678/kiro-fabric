...
run('Installing Kiro agents and project configuration', process.execPath, [path.join(root, 'dist/cli/main.js'), 'install-kiro', '--format', 'json', ...args]);
...
run('Verifying installation', process.execPath, [path.join(root, 'dist/cli/main.js'), 'doctor', '--format', 'json']);
