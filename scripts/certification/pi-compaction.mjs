...
// Keep the certification tuple aligned with the pinned package dependency.
// Updating Pi requires re-running this certificate; do not silently accept a
// semver range here because compaction internals are intentionally inspected.
const CERTIFIED_PI_VERSION = "0.84.2";
